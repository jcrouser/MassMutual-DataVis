...
p1 +
  geom_point(aes(), # incorrect! 2 is not a variable
                size = 2, color="red")   # this is fine -- turns all points red
```
...
This lab was adapted for SDS192: an Introduction to Data Science in Spring 2017 by R. Jordan Crouser at Smith College, and for the MassMutual Data Visualization workshop in Summer 2017 by Amelia McNamara.
</div>